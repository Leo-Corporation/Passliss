...
export default function ActivityItem(props: ActivityProps) {
  ...
  return (
    <div
      onClick={Copy}
      className="m-3 grid cursor-pointer grid-cols-2 rounded-lg border border-slate-200 p-3 shadow-sm hover:bg-slate-100 sm:cursor-default dark:border-slate-600 dark:hover:bg-slate-900"
    >
