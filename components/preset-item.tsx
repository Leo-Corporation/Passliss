...
export default function PresetItem(props: Readonly<PresetItemProps>) {
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMinLower(Number.parseInt(e.target.value))
                                }
                                value={minLower}
                                type="number"
                                className="h-auto px-2 py-1"
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMaxLower(Number.parseInt(e.target.value))
                                }
                                value={maxLower}
                                type="number"
                                className="h-auto px-2 py-1"
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMinUpper(Number.parseInt(e.target.value))
                                }
                                value={minUpper}
                                type="number"
                                className="h-auto px-2 py-1"
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMaxUpper(Number.parseInt(e.target.value))
                                }
                                value={maxUpper}
                                type="number"
                                className="h-auto px-2 py-1"
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMinDigits(Number.parseInt(e.target.value))
                                }
                                value={minDigits}
                                type="number"
                                className="h-auto px-2 py-1"
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMaxDigits(Number.parseInt(e.target.value))
                                }
                                value={maxDigits}
                                type="number"
                                className="h-auto px-2 py-1"
                          ...
                          <div>
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMinSpecial(Number.parseInt(e.target.value))
                                }
                                value={minSpecial}
                                type="number"
                                className="h-auto px-2 py-1"
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  setMaxSpecial(Number.parseInt(e.target.value))
                                }
                                value={maxSpecial}
                                type="number"
                                className="h-auto px-2 py-1"
