...
export default function PresetItem(props: PresetItemProps) {
  ...
  return (
    <div
      key={props.id}
      className="border-accent bg-accent/10 hover:bg-accent-trans dark:bg-accent/10 dark:hover:bg-accent-trans m-2 grid h-[170px] w-full grid-cols-[1fr,auto] grid-rows-[auto,1fr] items-center rounded-md border px-4 py-2 transition sm:h-auto sm:w-[300px]"
    >
